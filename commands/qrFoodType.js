  ...
  return event.reply({
    ...
    quickReply: {
      items: [
        ...
        {
          type: "action",
          action: { type: "message", label: "🍜 河粉", text: "找河粉" },
        },
        {
          type: "action",
        ...
        {
          type: "action",
          action: { type: "message", label: "🍛 咖哩", text: "找咖哩" },
        },
        {
          type: "action",
        ...
        {
          type: "action",
          action: { type: "message", label: "🥬 素食", text: "找素食" },
        },
        {
          type: "action",
        ...
        {
          type: "action",
          action: { type: "message", label: "🍔 速食", text: "找速食" },
        },
        {
          type: "action",
        ...
        {
          type: "action",
          action: { type: "message", label: "🥤 手搖飲", text: "找手搖飲" },
        },
      ],
    },
  });
